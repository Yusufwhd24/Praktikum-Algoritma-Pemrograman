...
while menu == "y" or "Y":
    ...
    namaAlamat=str(input("Masukkan nama alamat ="))
    namaNotelepon=str(input("Masukkan nama notelepon ="))
    namaHargaperbarang=str(input("Masukkan nama harga per barang ="))
    namaHargatotal=str(input("Masukkan nama harga total ="))
